...
# raid/datasets/のパスはMac環境では用意できないため、Macのフォルダ構成に即してオリジナルのコードを書き換える
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default='dinov2_vitb14_reg')
    parser.add_argument('--img_dir', type=str, default='/Users/isaoishikawa/FSC147_384_V2/images_384_VarV2')
    parser.add_argument('--density_map_dir', type=str, default='/Users/isaoishikawa/FSC147_384_V2/gt_density_map_adaptive_384_VarV2')
    parser.add_argument('--annotation', type=str, default='/Users/isaoishikawa/FSC147_384_V2/annotation_FSC147_384.json')
    parser.add_argument('--splits', type=str, default='/Users/isaoishikawa/FSC147_384_V2/Train_Test_Val_FSC_147.json')
