#!/usr/bin/env python3
"""
Gradio Beard Detection & Removal Application
...
ワークフロー:
1. Tab 1: 髭検出 → 削除対象を選択
2. Tab 2: 削除対象をInpainting
3. Tab 3: 色補正 → 残した髭をオーバーレイ → 最終出力

Usage:
    python app_inpainting_coloring.py
...
import gradio as gr
from utils import BeardRemovalPipeline
import numpy as np
